...
# Instruction code for exchange instruction
...
bool instr_valid = f_icode in 
	{ INOP, IHALT, IRRMOVL, IIRMOVL, IRMMOVL, IMRMOVL, IMUTEX,
...
bool need_valC =
	f_icode in { IIRMOVL, IRMMOVL, IMRMOVL, IJXX, 
		     IIADDL, ICALL, IMUTEX };
...
int d_srcA = [
	D_icode in { IRRMOVL, IRMMOVL, IOPL, IPUSHL, IMUTEX  } : D_rA;
...
int aluB = [
	E_icode in { IRMMOVL, IMRMOVL, IOPL, ICALL, ILEAVE,
		     IPUSHL, IRET, IPOPL, IIADDL, IMUTEX } : E_valB;
