...
intsig M_srcA 'ex_mem_curr->srca'	# Source A register ID
...
int e_valA = [
	# My code 4.57
	M_icode in { IMRMOVL, IPOPL } && E_icode in { IPUSHL } && M_dstM in { E_srcA, E_srcB } : m_valM;
...
bool F_stall =
	...
	# My code 4.57
	E_icode in { IMRMOVL, IPOPL } && E_dstM in { d_srcA, d_srcB } && !(D_icode in { IPUSHL }) ||
